...
values ('readiness_v1', 'v1', $$
{
  ...
  "soft_gates": [
    ...
    {
      "when": "answers['3.3'] in ['no','not_sure']",
      "questions": [
        "3.4"
      ],
      "result": "na",
    ...
    {
      "when": "answers['6.6'] in ['no','not_sure']",
      "questions": [
        "6.7"
      ],
      "result": "na",
    ...
    {
      "when": "answers['10.4'] in ['no','not_sure']",
      "questions": [
        "10.5"
      ],
      "result": "na",
  ...
  "questions": [
    ...
    {
      "id": "3.3",
      "item_id": "financial.accounts.has_beneficiaries",
      "section_id": "3",
      "dimension": "Financial_Insurance",
      "weight": 0,
    ...
    {
      "id": "4.1",
      "item_id": "family.dependents.exists",
      "section_id": "4",
      "dimension": "Family_Relationships",
      "weight": 0,
    ...
    {
      "id": "6.6",
      "item_id": "digital.assets.crypto.exists",
      "section_id": "6",
      "dimension": "Digital_Life",
      "weight": 0,
    ...
    {
      "id": "9.1",
      "item_id": "parents.supporting.exists",
      "section_id": "9",
      "dimension": "Supporting_Aging_Parents",
      "weight": 0,
    ...
    {
      "id": "10.4",
      "item_id": "home.personal_property.exists",
      "section_id": "10",
      "dimension": "Home_Personal_Property",
      "weight": 0,
