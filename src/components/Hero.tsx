  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-20 left-10 w-80 h-80 bg-accent/30 rounded-full blur-3xl animate-float"
          style={{
            animationDelay: "2s",
          }}
        />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 lg:space-y-8">
            ...
            <AnimatedItem animation="fade-up" delay={100}>
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold text-foreground leading-tight text-balance">
                Get your affairs in order with <span className="text-primary">Rest Easy</span>
              </h1>
            </AnimatedItem>
            ...
            <AnimatedItem animation="fade-up" delay={200}>
              <p className="font-body text-lg lg:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Rest Easy helps you achieve Life Readiness — organizing your affairs for any unexpected moment, not just
                end-of-life.
              </p>
            </AnimatedItem>
          ...
          <AnimatedItem animation="scale" delay={200} className="relative flex justify-center lg:justify-end">
            <div className="relative">
              ...
              {/* Floating cards */}
              <Card
                className="absolute -top-4 -left-8 shadow-card animate-float border-border/50"
                style={{
                  animationDelay: "1s",
                }}
              >
              ...
              <Card
                className="absolute -bottom-4 -right-8 shadow-card animate-float border-border/50"
                style={{
                  animationDelay: "3s",
                }}
              >
