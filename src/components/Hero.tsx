...
import { BentoGrid } from "@/components/landing";

const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-gradient-hero pt-20 pb-12 lg:pb-20">
