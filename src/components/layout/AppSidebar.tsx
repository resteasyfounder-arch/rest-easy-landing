import { Home, ClipboardList, BarChart3, Settings, LogIn, Sparkles } from "lucide-react";
...
const navItems = [
  ...
  { title: "Try Sample", url: "/sample", icon: Sparkles },
  { title: "Full Assessment", url: "/assessment", icon: ClipboardList },
